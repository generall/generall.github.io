...
(function() {
  ...
  MathJax = (function() {
    function MathJax(options) {
      this.options = options;
      this.load = bind(this.load, this);
      this.bind();
    }

    MathJax.prototype.load = function() {
      window.MathJax = null;
      return this._fetch().done((function(_this) {
        return function() {
          return window.MathJax.Hub.Config(_this.options);
        };
      })(this));
    };

    MathJax.prototype.bind = function() {
      $((function(_this) {
        return function() {
          return _this.load();
        };
      })(this));
      return $(document).on('turbolinks:load', this.load);
    };

    MathJax.prototype.unbind = function() {
      return $(document).off('page:load', this.load);
    };

    MathJax.prototype._fetch = function() {
      return $.ajax({
        dataType: 'script',
        cache: true,
